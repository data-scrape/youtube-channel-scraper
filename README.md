...
[![GitHub stars](https://img.shields.io/github/stars/data-scrape/youtube-channel-scraper?style=social)](https://github.com/data-scrape/youtube-channel-scraper)
[![GitHub forks](https://img.shields.io/github/forks/data-scrape/youtube-channel-scraper?style=social)](https://github.com/data-scrape/youtube-channel-scraper/fork)
[![GitHub issues](https://img.shields.io/github/issues/data-scrape/youtube-channel-scraper)](https://github.com/data-scrape/youtube-channel-scraper/issues)
[![GitHub license](https://img.shields.io/github/license/data-scrape/youtube-channel-scraper)](https://github.com/data-scrape/youtube-channel-scraper/blob/main/LICENSE)
[![Python](https://img.shields.io/badge/Python-3.8+-blue?logo=python)](https://www.python.org/)

</div>


> YouTube channel scraper - extract channel data, videos, subscriber counts


<!-- SEO keywords: youtube channel scraper, Youtube Channel Scraper, youtube channel scraper python, youtube channel scraper github -->
...
- Extract YouTube channel data: name, subscribers, video count
- Channel description, banner, profile image
- Channel creation date and total views
- All video URLs from a channel
- Playlist extraction with video counts
- Channel statistics and growth metrics

## 🎯 Use Cases

Analyze competitor channels, track growth, extract video URLs.
...
```bash
git clone https://github.com/data-scrape/youtube-channel-scraper.git
...
```python
from youtube_channel_scraper import Scraper
...
```bash
python youtube_channel_scraper.py --query "your-query" --output results.json
```
...
### Is Youtube Channel Scraper legal to use?
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/data-scrape/youtube-channel-scraper)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/data-scrape/youtube-channel-scraper/issues)
